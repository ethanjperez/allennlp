...
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ab.m=sl.bsz=32.lr=1e-5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ab -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f #prince
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.aba.m=sl.bsz=32.lr=1e-5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d aba -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f #prince
...
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ba.m=sl.bsz=32.lr=1e-5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ba -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=B_A_B_A_B_A_B_A.all.pkl -a 32 -c concat -f #prince
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.bab.m=sl.bsz=32.lr=1e-5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d bab -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=B_A_B_A_B_A_B_A.all.pkl -a 32 -c concat -f #prince
...
# Concat SL L
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl.bsz=32.lr=1e-5.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.l.m=sl.bsz=32.lr=5e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.l.m=sl.bsz=32.lr=3e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=2e-6.jsonnet -s tmp/race.l.m=sl.bsz=32.lr=2e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl.bsz=64.lr=1e-5.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 64 -c concat -f
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.l.m=sl.bsz=64.lr=5e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 64 -c concat -f
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.l.m=sl.bsz=64.lr=3e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 64 -c concat -f
allennlp train training_config/race.best.debate.lr=2e-6.jsonnet -s tmp/race.l.m=sl.bsz=64.lr=2e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 64 -c concat -f

allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f

allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.l.m=sl-sents.bsz=32.lr=5e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.l.m=sl-sents-delta.bsz=32.lr=5e-6.c=concat.2 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=A_B_A_B_A_B_A_B.all.pkl -a 32 -c concat -f

tb race.l.m=sl.bsz=32.lr=1e-5.c=concat:race.l.m=sl.bsz=32.lr=1e-5.c=concat,race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat:race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat,race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat:race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat,race.l.m=sl.bsz=32.lr=5e-6.c=concat:race.l.m=sl.bsz=32.lr=5e-6.c=concat,race.l.m=sl-sents.bsz=32.lr=5e-6.c=concat:race.l.m=sl-sents.bsz=32.lr=5e-6.c=concat,race.l.m=sl-sents-delta.bsz=32.lr=5e-6.c=concat:race.l.m=sl-sents-delta.bsz=32.lr=5e-6.c=concat --port 7011
