...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=5e-6.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #3 TODO: Continue/run longer
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=1e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #1 TODO: Continue/run longer
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=2e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #5 (TODO: Continue/run longer)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=3e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #7 (TODO: Continue/run longer)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=5e-6.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #4 TODO: Continue/run longer
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=1e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #2 TODO: Continue/run longer
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=2e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #6 (TODO: Continue/run longer)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=3e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #8 (TODO: Continue/run longer)
...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #TODO: Redo!
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #TODO: Redo!
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #TODO: Redo!
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #TODO: Redo!
