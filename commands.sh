...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=5e-6.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=1e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=2e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=3e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=5e-6.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=1e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=2e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents-delta.lr=3e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
...
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO
...
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #NB
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #NB
