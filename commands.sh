...
# TODO: Eval
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e.backup -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ ⅰ -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}" -ss -e -r
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e.backup -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ ⅱ -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}" -ss -e -r
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e.backup -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ ⅲ -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}" -ss -e -r
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e.backup -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ ⅳ -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}" -ss -e -r

# TODO on v100: Resume training until loss increases
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d e -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" -r

# SL on short passage model
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=5e-6.m=sl-sents.e -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d e -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}"
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.num_sents_leq_12.c=concat.bsz=12.lr=1e-5.m=sl-sents.e -j tmp/race.num_sents_leq_12.best.f/model.tar.gz -d e -m sl-sents -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.all.pkl -a 12 -c concat -o "{'train_data_path': 'datasets/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}"
...
tb race_m.c=concat.bsz=12.lr=5e-6.m=sl-sents.e:race_m.c=concat.bsz=12.lr=5e-6.m=sl-sents.e,race_m.c=concat.bsz=12.lr=1e-5.m=sl-sents.e:race_m.c=concat.bsz=12.lr=1e-5.m=sl-sents.e,race_m.c=concat.bsz=12.lr=2e-5.m=sl-sents.e:race_m.c=concat.bsz=12.lr=2e-5.m=sl-sents.e --port 9021
...
## Run SL/Sents/Influence on Test
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.m=sl.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅰ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl.best.e/d=ⅰ.c=concat.test.txt
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.m=sl.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅱ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl.best.e/d=ⅱ.c=concat.test.txt
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.m=sl.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅲ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl.best.e/d=ⅲ.c=concat.test.txt
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.m=sl.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅳ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl.best.e/d=ⅳ.c=concat.test.txt

# TODO: Look through code to verify decisions would be the same / verify with a script or diffchecker. Also probabilities would be calculated incorrectly in previous version (using -m sl).
...
# SL
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.e.c=concat.bsz=12.lr=5e-6.m=sl -j tmp/race.best.f/model.tar.gz -b 1 -d e -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #56.8 @ Epoch 6
...
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents.i -j tmp/race.best.f/model.tar.gz -b 1 -d e -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #54.3 @ Epoch 4
...
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents -j tmp/race.best.f/model.tar.gz -b 1 -d e -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #55.1 @ Epoch 5
...
tb race.e.c=concat.bsz=12.lr=5e-6.m=sl:race.e.c=concat.bsz=12.lr=5e-6.m=sl,race.e.c=concat.bsz=12.lr=1e-5.m=sl:race.e.c=concat.bsz=12.lr=1e-5.m=sl,race.e.c=concat.bsz=12.lr=2e-5.m=sl:race.e.c=concat.bsz=12.lr=2e-5.m=sl,race.e.c=concat.bsz=12.lr=2e-5.m=sl-sents.i:race.e.c=concat.bsz=12.lr=2e-5.m=sl-sents.i,race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents.i:race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents.i,race.e.c=concat.bsz=12.lr=5e-6.m=sl-sents.i:race.e.c=concat.bsz=12.lr=5e-6.m=sl-sents.i,race.e.c=concat.bsz=12.lr=2e-5.m=sl-sents:race.e.c=concat.bsz=12.lr=2e-5.m=sl-sents,race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents:race.e.c=concat.bsz=12.lr=1e-5.m=sl-sents,race.e.c=concat.bsz=12.lr=5e-6.m=sl-sents:race.e.c=concat.bsz=12.lr=5e-6.m=sl-sents --port 9011

# Produce human eval Oracle data
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ -c concat -p tmp/race.best.f.eval.dev.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ/oracle_outputs.c=concat.d=ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ/oracle_outputs.c=concat.d=ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ -c concat -p tmp/race.best.f.eval.dev.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ/oracle_outputs.c=concat.d=ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ/oracle_outputs.c=concat.d=ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ -c concat -p tmp/race.best.f.eval.dev.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ/oracle_outputs.c=concat.d=ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ/oracle_outputs.c=concat.d=ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ -c concat -p tmp/race.best.f.eval.dev.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ/oracle_outputs.c=concat.d=ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ/oracle_outputs.c=concat.d=ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ -c concat -p tmp/race.best.f.eval.dev.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ/oracle_outputs.c=concat.d=ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ/oracle_outputs.c=concat.d=ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dev.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ -c concat -p tmp/race.best.f.eval.dev.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ/oracle_outputs.c=concat.d=ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f.eval.dev.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ/oracle_outputs.c=concat.d=ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ ⅠⅡ -c concat -p tmp/race.best.f.eval.test.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ/oracle_outputs.c=concat.d=ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ/oracle_outputs.c=concat.d=ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ_ⅠⅡ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ ⅠⅢ -c concat -p tmp/race.best.f.eval.test.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ/oracle_outputs.c=concat.d=ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ/oracle_outputs.c=concat.d=ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ_ⅠⅢ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ ⅠⅣ -c concat -p tmp/race.best.f.eval.test.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ/oracle_outputs.c=concat.d=ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ/oracle_outputs.c=concat.d=ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ_ⅠⅣ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ ⅡⅢ -c concat -p tmp/race.best.f.eval.test.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ/oracle_outputs.c=concat.d=ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ/oracle_outputs.c=concat.d=ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ_ⅡⅢ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ ⅡⅣ -c concat -p tmp/race.best.f.eval.test.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ/oracle_outputs.c=concat.d=ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ/oracle_outputs.c=concat.d=ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ_ⅡⅣ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ -j tmp/race.best.last_epoch.f/model.tar.gz -e -f -d ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ ⅢⅣ -c concat -p tmp/race.best.f.eval.test.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ/oracle_outputs.c=concat.d=ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ/oracle_outputs.c=concat.d=ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ_ⅢⅣ.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.test.qtype=A -j tmp/race.best.last_epoch.f/model.tar.gz -e -d f -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=f.test.qtype=A.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/A'}\" 2>&1 | tee tmp/race.best.f/d=f.c=concat.test.qtype=A.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.test.qtype=B -j tmp/race.best.last_epoch.f/model.tar.gz -e -d f -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=f.test.qtype=B.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/d=f.c=concat.test.qtype=B.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.test.qtype=C -j tmp/race.best.last_epoch.f/model.tar.gz -e -d f -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=f.test.qtype=C.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/d=f.c=concat.test.qtype=C.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.test.qtype=D -j tmp/race.best.last_epoch.f/model.tar.gz -e -d f -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=f.test.qtype=D.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/d=f.c=concat.test.qtype=D.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.test.qtype=E -j tmp/race.best.last_epoch.f/model.tar.gz -e -d f -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=f.test.qtype=E.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/d=f.c=concat.test.qtype=E.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.Ⅱ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.Ⅲ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅲ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.Ⅳ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅳ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅳ/oracle_outputs.c=concat.d=Ⅳ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f.eval.test.Ⅳ/oracle_outputs.c=concat.d=Ⅳ.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dream.test.num_questions=100.Ⅰ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ -c concat -p tmp/race.best.f.eval.dream.test.num_questions=100.Ⅰ/oracle_outputs.c=concat.d=Ⅰ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/dream/train.json', 'validation_data_path': 'datasets/dream/test.num_questions=100.json', 'dataset_reader': {'type': 'dream-mc'}}\" 2>&1 | tee tmp/race.best.f.eval.dream.test.num_questions=100.Ⅰ/oracle_outputs.c=concat.d=Ⅰ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dream.test.num_questions=100.Ⅱ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ -c concat -p tmp/race.best.f.eval.dream.test.num_questions=100.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/dream/train.json', 'validation_data_path': 'datasets/dream/test.num_questions=100.json', 'dataset_reader': {'type': 'dream-mc'}}\" 2>&1 | tee tmp/race.best.f.eval.dream.test.num_questions=100.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.dream.test.num_questions=100.Ⅲ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅲ -c concat -p tmp/race.best.f.eval.dream.test.num_questions=100.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/dream/train.json', 'validation_data_path': 'datasets/dream/test.num_questions=100.json', 'dataset_reader': {'type': 'dream-mc'}}\" 2>&1 | tee tmp/race.best.f.eval.dream.test.num_questions=100.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.human_eval.Ⅰ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅰ/oracle_outputs.c=concat.d=Ⅰ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test.human_eval'}\" 2>&1 | tee tmp/race.best.f.eval.test.human_eval.Ⅰ/oracle_outputs.c=concat.d=Ⅰ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.human_eval.Ⅱ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test.human_eval'}\" 2>&1 | tee tmp/race.best.f.eval.test.human_eval.Ⅱ/oracle_outputs.c=concat.d=Ⅱ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.human_eval.Ⅲ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅲ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test.human_eval'}\" 2>&1 | tee tmp/race.best.f.eval.test.human_eval.Ⅲ/oracle_outputs.c=concat.d=Ⅲ.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f.eval.test.human_eval.Ⅳ -j tmp/race.best.f/model.tar.gz -e -f -d Ⅳ -c concat -p tmp/race.best.f.eval.test.human_eval.Ⅳ/oracle_outputs.c=concat.d=Ⅳ.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test.human_eval'}\" 2>&1 | tee tmp/race.best.f.eval.test.human_eval.Ⅳ/oracle_outputs.c=concat.d=Ⅳ.txt
...
# Produce human eval Oracle data using last checkpoint
...
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d ⅰ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=ⅰ.test.pkl -o \"{'validation_data_path': 'datasets/race_raw/test'}\"
...
# Test commands:
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" 2>&1 | tee tmp/race.best.f/eval-A-concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}" 2>&1 | tee tmp/race.best.f/eval-A-concat.test.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train'}" 2>&1 | tee tmp/race.best.f/eval-A-concat.train.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d r -p tmp/race.best.f/oracle_outputs.dev.d=r.5.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" 2>&1 | tee tmp/race.best.f/eval-r-concat.5.txt
...
### RACE Multi-turn: ⅰ ⅱ
# 1-step training: Full HP Sweep SL-Sents: m={sl-sents,sl-sents-delta} bsz={16,32} lr={3e-5,2e-5,1e-5,5e-6}
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=5e-6.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #Reward: 71.04/43.65
...
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=2e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #Reward: 71.6/44.88
...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=5e-6.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=1e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=2e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f # best (excluding bsz=8,12): Reward: 70.90 (correct stance Judge prob.)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=3e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=5e-6.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=1e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=2e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.lr=3e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #

tb race.ⅱ.m=sl-sents.lr=5e-6.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=5e-6.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=1e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=1e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=2e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=2e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=3e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=3e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=5e-6.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=5e-6.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=1e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=1e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=2e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=2e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=3e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=3e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=5e-6.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=5e-6.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=1e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=1e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=2e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=2e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=3e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=3e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=5e-6.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=5e-6.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=1e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=1e-5.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=2e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=2e-5.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.lr=3e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.lr=3e-5.bsz=32.n=1.x=0.5.c=concat --port 8030
...
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=8.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #71.93/45.32
...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f # BEST: 72.12/45.62 (Reward: correct/incorrect stance Judge prob.). 40.29/23.84 (Influence: correct/incorrect stance).
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=12.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=16.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=32.n=1.x=0.5.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl-sents -i -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #

tb race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=8.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=8.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=12.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=12.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=16.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=16.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=5e-6.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=1e-5.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=2e-5.bsz=32.n=1.x=0.5.c=concat,race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=32.n=1.x=0.5.c=concat:race.ⅱ.m=sl-sents.i.lr=3e-5.bsz=32.n=1.x=0.5.c=concat --port 8031

# 1/2/4(6)-step training: Full HP Sweep
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #

allennlp train training_config/race.best.debate.lr=5e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #c
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #g (r)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 8 -c concat -f #c (r)
allennlp train training_config/race.best.debate.lr=5e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #c
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #good
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 12 -c concat -f #best: Reward: 71.97 (correct stance Judge prob.)
allennlp train training_config/race.best.debate.lr=5e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #c
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #g (r?)
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #c
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #c
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 16 -c concat -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #c
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -a 32 -c concat -f #c

tb race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=8.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=8.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=12.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=12.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-5.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat,race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat:race.ⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat --port 8032

allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #(hpc) NB: Copy from hpc
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #(hpc) NB: Copy from hpc
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #(hpc) NB: Copy from hpc
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #(hpc) NB: Copy from hpc
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #c best (among bsz=16,32)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c best (among bsz=16,32)

tb race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat,race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat:race.ⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat --port 8033

allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f # best (among bsz=32)
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #NB

tb race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=16.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat,race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat:race.ⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat --port 8034

allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO(e) (still)
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO(e) (still)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 8 -c concat -n 1 -x 0.5 -f #TODO(e) (still)
allennlp train training_config/race.best.debate.lr=3e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 12 -c concat -n 1 -x 0.5 -f #TODO(e)
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f # best: (probably among all). Turn 0: 38.845 -> 41.29 -> 44.17. Turn 1: 27.53 -> 29.485 -> 30.875. Turn 2: 31.86 -> 36.68 -> 35.605. Turn 3: 29.425 -> 30.02 -> 32.49. Turn 4: 34.68 -> 33.8 -> 35.11. Turn 5: 31.05 -> 31.18 -> 34
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 16 -c concat -n 1 -x 0.5 -f #
allennlp train training_config/race.best.debate.lr=2e-5.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
...
allennlp train training_config/race.best.debate.lr=5e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #c
allennlp train training_config/race.best.debate.lr=3e-6.jsonnet -s tmp/race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -b 1 -d ⅰ ⅱ ⅰ ⅱ ⅰ ⅱ -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=6_ⅠⅡ_turns.all.pkl -a 32 -c concat -n 1 -x 0.5 -f #NB


tb race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=8.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=8.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=12.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=12.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=16.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=16.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=16.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=2e-5.bsz=32.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=5e-6.bsz=32.c=concat,race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=3e-6.bsz=32.c=concat --port 8035

tb race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat --port 8036
tb race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat:race.ⅰⅱⅰⅱⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=16.c=concat --port 8037

# Random last sentence evaluation
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅱ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d ⅱ -c concat -m sl-random -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=r.c=concat.dev.ⅠⅡ.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅰ_ⅱ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅰ_Ⅱ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅰ_Ⅱ_Ⅰ_ⅱ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=3_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅰ_Ⅱ_Ⅰ_Ⅱ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=5_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅱ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅱ_Ⅰ_ⅱ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅱ_Ⅰ_Ⅱ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=3_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅱ_Ⅰ_Ⅱ_Ⅰ_ⅱ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ Ⅰ Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_ⅰ.m=sl-random.c=concat -j tmp/race.best.f/model.tar.gz -e -f -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=5_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt

#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d ⅱ -c concat -m sl-random -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=r.c=concat.dev.ⅠⅡ.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅰ Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=3_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=5_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=2_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=3_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ ⅱ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=4_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_r.c=concat.dev.txt
#allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.ⅰⅱ.m=sl.n=1.x=0.5.lr=1e-5.bsz=32.c=concat -j tmp/race.best.f/model.tar.gz -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ ⅰ -c concat -m sl-random -p tmp/race.best.f/oracle_outputs.c=concat.d=5_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_r.c=concat.dev.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_A_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B A B r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_A_B_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B A B A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_A_B_A_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B A B A B r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_A_B_A_B_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B A B A B A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=A_B_A_B_A_B_A_r.c=concat.dev.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=B_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=B_A_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A B r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=B_A_B_r.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A B A r -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=8_AB_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=B_A_B_A_r.c=concat.dev.txt
...
### RACE
# Oracle: A W / W A
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A W A W A W A W A W A W -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=A_W_A_W_A_W_A_W_A_W_A_W.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=A_W_A_W_A_W_A_W_A_W_A_W.c=concat.test.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d W A W A W A W A W A W A -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=W_A_W_A_W_A_W_A_W_A_W_A.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=W_A_W_A_W_A_W_A_W_A_W_A.c=concat.test.txt

# Oracle: Ⅰ Ⅱ Ⅲ Ⅳ
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d ⅠⅡⅢⅣ ⅠⅡⅢⅣ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.race.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.c=concat.race.dev.txt

# Ⅰ Ⅱ
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.0.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.0'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.0.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.1.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.1'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.1.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.2.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.2'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.3.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.3'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.3.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.4.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.4'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.4.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.5.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.5'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.5.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.6.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.6'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.6.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.7.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.7'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.7.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.8.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.8'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.8.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.train.9.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.9'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.train.9.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ.c=concat.test.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.0.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.0'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.0.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.1.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.1'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.1.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.2.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.2'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.3.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.3'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.3.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.4.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.4'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.4.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.5.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.5'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.5.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.6.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.6'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.6.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.7.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.7'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.7.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.8.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.8'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.8.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.train.9.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.9'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.train.9.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ Ⅱ Ⅰ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ_Ⅱ_Ⅰ.c=concat.test.txt

# Ⅲ Ⅳ TODO(d)
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.0.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.0'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.0.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.1.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.1'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.1.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.2.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.2'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.3.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.3'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.3.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.4.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.4'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.4.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.5.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.5'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.5.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.6.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.6'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.6.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.7.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.7'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.7.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.8.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.8'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.8.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.train.9.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.9'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.train.9.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ.c=concat.test.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.0.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.0'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.0.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.1.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.1'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.1.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.2.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.2'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.3.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.3'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.3.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.4.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.4'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.4.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.5.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.5'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.5.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.6.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.6'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.6.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.7.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.7'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.7.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.8.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.8'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.8.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.train.9.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.9'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.train.9.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ Ⅳ Ⅲ -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.test.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.best.f/d=Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ_Ⅳ_Ⅲ.c=concat.test.txt
...
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=A.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/A'}\" 2>&1 | tee tmp/race.best.f/eval-AB-concat.qtype=A.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=A.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/A'}\" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.qtype=A.2.txt
...
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=A.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/A'}\" 2>&1 | tee tmp/race.best.f/eval-BA-concat.qtype=A.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B B -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=A.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/A'}\" 2>&1 | tee tmp/race.best.f/eval-BB-concat.qtype=A.2.txt

# B (Paraphrasing)
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A A -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=B.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-AA-concat.qtype=B.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=B.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-AB-concat.qtype=B.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=B.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.qtype=B.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d r r -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-rr-concat.qtype=B.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=B.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-BA-concat.qtype=B.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B B -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=B.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/B'}\" 2>&1 | tee tmp/race.best.f/eval-BB-concat.qtype=B.2.txt

# C (Single-sentence reasoning)
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A A -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=C.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-AA-concat.qtype=C.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=C.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-AB-concat.qtype=C.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=C.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.qtype=C.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d r r -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-rr-concat.qtype=C.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=C.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-BA-concat.qtype=C.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B B -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=C.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/C'}\" 2>&1 | tee tmp/race.best.f/eval-BB-concat.qtype=C.2.txt

# D (Multi-sentence reasoning)
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A A -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=D.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-AA-concat.qtype=D.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=D.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-AB-concat.qtype=D.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=D.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.qtype=D.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d r r -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-rr-concat.qtype=D.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=D.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-BA-concat.qtype=D.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B B -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=D.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/D'}\" 2>&1 | tee tmp/race.best.f/eval-BB-concat.qtype=D.2.txt

# E (Ambiguous)
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A A -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=E.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-AA-concat.qtype=E.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A B -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=E.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-AB-concat.qtype=E.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=AA.qtype=E.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.qtype=E.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d r r -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-rr-concat.qtype=E.txt

allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B A -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=E.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-BA-concat.qtype=E.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d B B -p tmp/race.best.f/oracle_outputs.c=concat.d=BA.qtype=E.all.pkl -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/E'}\" 2>&1 | tee tmp/race.best.f/eval-BB-concat.qtype=E.2.txt

# Ar
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d A r -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" 2>&1 | tee tmp/race.best.f/eval-Ar-concat.txt
...
# Concat SL Multi-step (Prince): AB, ABAB, BA, BABA. NB: m={sl-sents,sl-sents-delta}?
...
# Concat SL L
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl.bsz=32.lr=1e-5.c=concat.4 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.4 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -a 32 -c concat -f
allennlp train training_config/race.best.debate.lr=1e-5.jsonnet -s tmp/race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.4 -j tmp/race.best.f/model.tar.gz -b 1 -d l -m sl-sents-delta -p tmp/race.best.f/oracle_outputs.c=concat.d=1_AB_turns.all.pkl -a 32 -c concat -f

tb race.l.m=sl.bsz=32.lr=1e-5.c=concat.4:race.l.m=sl.bsz=32.lr=1e-5.c=concat.4,race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.4:race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.4,race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.4:race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.4 --port 7011
tb race.l.m=sl.bsz=32.lr=1e-5.c=concat.3:race.l.m=sl.bsz=32.lr=1e-5.c=concat.3,race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.3:race.l.m=sl-sents.bsz=32.lr=1e-5.c=concat.3,race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.3:race.l.m=sl-sents-delta.bsz=32.lr=1e-5.c=concat.3 --port 7010
...
allennlp train training_config/bert_mc_q2a.race.lr=5e-5.Ejsonnet -s tmp/race.bert_mc_q2a.bsz=32.lr=5e-5.f -d f -a 4 -f #24.8
...
tb race.bert_mc_pq2a.bsz=32.lr=5e-6.a=8.f:race.bert_mc_pq2a.bsz=32.lr=5e-6.a=8.f,race.bert_mc_pq2a.bsz=32.lr=1e-5.a=8.f:race.bert_mc_pq2a.bsz=32.lr=1e-5.a=8.f,race.bert_mc_pq2a.bsz=32.lr=2e-5.a=8.f:race.bert_mc_pq2a.bsz=32.lr=2e-5.a=8.f,race.bert_mc_pq2a.bsz=32.lr=3e-5.a=8.f:race.bert_mc_pq2a.bsz=32.lr=3e-5.a=8.f,race.bert_mc_pq2a.bsz=32.lr=5e-5.a=8.f:race.bert_mc_pq2a.bsz=32.lr=5e-5.a=8.f,race.bert_mc_pq2a.bsz=16.lr=5e-6.a=4.f:race.bert_mc_pq2a.bsz=16.lr=5e-6.a=4.f,race.bert_mc_pq2a.bsz=16.lr=1e-5.a=4.f:race.bert_mc_pq2a.bsz=16.lr=1e-5.a=4.f,race.bert_mc_pq2a.bsz=16.lr=2e-5.a=4.f:race.bert_mc_pq2a.bsz=16.lr=2e-5.a=4.f,race.bert_mc_pq2a.bsz=16.lr=3e-5.a=4.f:race.bert_mc_pq2a.bsz=16.lr=3e-5.a=4.f,race.bert_mc_pq2a.bsz=16.lr=5e-5.a=4.f:race.bert_mc_pq2a.bsz=16.lr=5e-5.a=4.f --port 9011
...
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d AA -p tmp/race.best.f/oracle_outputs.dev.d=AA.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" 2>&1 | tee tmp/race.best.f/eval-AA-concat.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.best.f -e -r -d BB -p tmp/race.best.f/oracle_outputs.dev.d=BB.pkl -c concat -o "{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/dev'}" 2>&1 | tee tmp/race.best.f/eval-BB-concat.txt
...
# MC: Full passage
allennlp train training_config/bert.race_mc.lr=2e-5.jsonnet -s tmp/race_mc.bert.bsz=32.lr=2e-5.f -d f -a 8 -f # 25
allennlp train training_config/bert.race_mc.lr=3e-5.jsonnet -s tmp/race_mc.bert.bsz=32.lr=3e-5.f -d f -a 8 -f # 45.0
allennlp train training_config/bert.race_mc.lr=5e-5.jsonnet -s tmp/race_mc.bert.bsz=32.lr=5e-5.f -d f -a 8 -f # 25
allennlp train training_config/bert.race_mc.lr=2e-5.jsonnet -s tmp/race_mc.bert.bsz=16.lr=2e-5.f -d f -a 4 -f # 25
allennlp train training_config/bert.race_mc.lr=3e-5.jsonnet -s tmp/race_mc.bert.bsz=16.lr=3e-5.f -d f -a 4 -f # 25
allennlp train training_config/bert.race_mc.lr=5e-5.jsonnet -s tmp/race_mc.bert.bsz=16.lr=5e-5.f -d f -a 4 -f # OOM
...
rsync -rav -e ssh --include '*/' --include 'events.out.tfevents.*' --include '*.json' --include '*.txt' --exclude='*' ejp416@prince.hpc.nyu.edu:~/research/allennlp/tmp/ ~/research/allennlp/tmp
