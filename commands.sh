...
# num_sents_leq_16
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #60.9+
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #61.9
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=2e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #62.13
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=3e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-6.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=1e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #61.94+
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=2e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=3e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-6.a=12.f -d f -a 12 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f -d f -a 12 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #62.4+
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=2e-5.a=12.f -d f -a 12 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=3e-5.a=12.f -d f -a 12 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-5.a=12.f -d f -a 12 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-6.a=8.f -d f -a 8 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f #61.39+
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=1e-5.a=8.f -d f -a 8 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=2e-5.a=8.f -d f -a 8 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=3e-5.a=8.f -d f -a 8 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/bert_mc_gpt.race.lr=5e-5.bsz=1.jsonnet -s tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-5.a=8.f -d f -a 8 -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f

tb race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f:race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f,race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f:race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f,race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=2e-5.a=32.f:race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=2e-5.a=32.f,race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=3e-5.a=32.f:race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=3e-5.a=32.f,race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-5.a=32.f:race.num_sents_leq_16.bert_mc_gpt.bsz=32.lr=5e-5.a=32.f,race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-6.a=16.f:race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-6.a=16.f,race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=1e-5.a=16.f:race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=1e-5.a=16.f,race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=2e-5.a=16.f:race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=2e-5.a=16.f,race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=3e-5.a=16.f:race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=3e-5.a=16.f,race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-5.a=16.f:race.num_sents_leq_16.bert_mc_gpt.bsz=16.lr=5e-5.a=16.f,race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-6.a=12.f:race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-6.a=12.f,race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f:race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f,race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=2e-5.a=12.f:race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=2e-5.a=12.f,race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=3e-5.a=12.f:race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=3e-5.a=12.f,race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-5.a=12.f:race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=5e-5.a=12.f,race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-6.a=8.f:race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-6.a=8.f,race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=1e-5.a=8.f:race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=1e-5.a=8.f,race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=2e-5.a=8.f:race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=2e-5.a=8.f,race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=3e-5.a=8.f:race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=3e-5.a=8.f,race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-5.a=8.f:race.num_sents_leq_16.bert_mc_gpt.bsz=8.lr=5e-5.a=8.f --port 9002
...
### RACE-M
# Oracle
allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d ⅠⅡⅢⅣ ⅠⅡⅢⅣ -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.race_m.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.c=concat.race_m.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d ⅠⅡⅢⅣ ⅠⅡⅢⅣ -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.race_h.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=ⅠⅡⅢⅣ_ⅠⅡⅢⅣ.c=concat.race_h.dev.txt

allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d B A -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=B_A.race_m.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=B_A.c=concat.race_m.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d B A -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=B_A.race_h.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=B_A.c=concat.race_h.dev.txt

allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d A B -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=A_B.race_m.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=A_B.c=concat.race_m.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d A B -c concat -p tmp/race_m.best.f/oracle_outputs.c=concat.d=A_B.race_h.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=A_B.c=concat.race_h.dev.txt
...
allennlp train training_config/bert_mc_a.race.lr=3e-5.jsonnet -s tmp/race_m.bert_mc_a.bsz=32.lr=3e-5.f -e -r -d f -c concat -p tmp/race_m.bert_mc_a.bsz=32.lr=3e-5.f/oracle_outputs.c=concat.d=f.race_h.dev.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.bert_mc_a.bsz=32.lr=3e-5.f/d=f.c=concat.race_h.dev.txt

allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d r -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=r.c=concat.race_h.dev.txt
allennlp train training_config/race.best.jsonnet -s tmp/race_m.best.f -e -r -d rr -c concat -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw_high/dev'}\" 2>&1 | tee tmp/race_m.best.f/d=rr.c=concat.race_h.dev.txt
...
allennlp train training_config/bert_mc_a.race.lr=3e-5.jsonnet -s tmp/race_m.bert_mc_a.bsz=32.lr=3e-5.f -d f -a 4 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # 41.36
allennlp train training_config/bert_mc_a.race.lr=5e-5.jsonnet -s tmp/race_m.bert_mc_a.bsz=32.lr=5e-5.f -d f -a 4 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # 33.64
...
# GPT-style
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # 67.27
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # 67.48
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=32.lr=2e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=32.lr=3e-5.a=32.f -d f -a 32 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
...
allennlp train training_config/bert_mc_gpt.race.lr=5e-6.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=16.lr=5e-6.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
allennlp train training_config/bert_mc_gpt.race.lr=1e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=16.lr=1e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
allennlp train training_config/bert_mc_gpt.race.lr=2e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=16.lr=2e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
allennlp train training_config/bert_mc_gpt.race.lr=3e-5.bsz=1.jsonnet -s tmp/race_m.bert_mc_gpt.bsz=16.lr=3e-5.a=16.f -d f -a 16 -o \"{'train_data_path': 'datasets/race_raw_middle/train', 'validation_data_path': 'datasets/race_raw_middle/dev'}\" -f # TODO
...
tb tmp/race_m.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f:tmp/race_m.bert_mc_gpt.bsz=32.lr=5e-6.a=32.f,tmp/race_m.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f:tmp/race_m.bert_mc_gpt.bsz=32.lr=1e-5.a=32.f --port 8000
