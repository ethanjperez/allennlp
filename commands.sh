...
# SL on num_sents_leq_16 model: TODO: Compute Oracle! TODO: Check num_sents_leq_12 models first!
allennlp train training_config/race.best.debate.sl.lr=5e-6.jsonnet -s tmp/race.e.num_sents_leq_16.c=concat.bsz=12.lr=5e-6.m=sl -j tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/model.tar.gz -b 1 -d e -m sl -p tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/oracle_outputs.c=concat.d=e.all.pkl -a 12 -c concat -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.e.num_sents_leq_16.c=concat.bsz=12.lr=1e-5.m=sl -j tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/model.tar.gz -b 1 -d e -m sl -p tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/oracle_outputs.c=concat.d=e.all.pkl -a 12 -c concat -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/race.best.debate.sl.lr=2e-5.jsonnet -s tmp/race.e.num_sents_leq_16.c=concat.bsz=12.lr=2e-5.m=sl -j tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/model.tar.gz -b 1 -d e -m sl -p tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/oracle_outputs.c=concat.d=e.all.pkl -a 12 -c concat -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f
allennlp train training_config/race.best.debate.sl.lr=3e-5.jsonnet -s tmp/race.e.num_sents_leq_16.c=concat.bsz=12.lr=3e-5.m=sl -j tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/model.tar.gz -b 1 -d e -m sl -p tmp/race.num_sents_leq_16.bert_mc_gpt.bsz=12.lr=1e-5.a=12.f/oracle_outputs.c=concat.d=e.all.pkl -a 12 -c concat -o \"{'train_data_path': 'datasets/race_raw.num_sents_leq_16/train', 'validation_data_path': 'datasets/race_raw.num_sents_leq_16/dev'}\" -f

allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.0.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.0'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.0.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.1.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.1'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.1.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.2.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.2'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.2.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.3.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.3'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.3.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.4.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.4'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.4.txt
allennlp train training_config/race.best.jsonnet -s tmp/race.num_sents_leq_12.best.f -e -r -d Ⅰ -c concat -p tmp/race.num_sents_leq_12.best.f/oracle_outputs.c=concat.d=Ⅰ.train.5.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/train.5'}\" 2>&1 | tee tmp/race.num_sents_leq_12.best.f/d=Ⅰ.c=concat.train.5.txt
...
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅰ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.best.e/d=ⅰ.c=concat.test.txt
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅱ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.best.e/d=ⅱ.c=concat.test.txt
...
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅳ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.best.e/d=ⅳ.c=concat.test.txt

allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.i.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅰ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.i.best.e/d=ⅰ.c=concat.test.txt
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.i.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅱ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.i.best.e/d=ⅱ.c=concat.test.txt
...
allennlp train training_config/race.best.debate.sl.lr=1e-5.jsonnet -s tmp/race.m=sl-sents.i.best.e -j tmp/race.best.f/model.tar.gz -e -r -b 1 -d ⅳ -m sl -a 12 -c concat -p tmp/race.best.f/oracle_outputs.c=concat.d=1_ⅠⅡ_turns.all.pkl -o \"{'train_data_path': 'allennlp/tests/fixtures/data/race_raw/train', 'validation_data_path': 'datasets/race_raw/test'}\" 2>&1 | tee tmp/race.m=sl-sents.i.best.e/d=ⅳ.c=concat.test.txt
