"""
fetch_dream_large.py

Obtain results (validation accuracy) on DREAM Bert Large training jobs.
"""
import argparse
import json
import os
...
if __name__ == "__main__":
    ...
    for b in BSZ:
        for l in LR:
            cdir = os.path.join(ROOT_DIR, 'dream.f.bert_mc_gpt.large.bsz=%d.lr=%s.f' % (b, l))
