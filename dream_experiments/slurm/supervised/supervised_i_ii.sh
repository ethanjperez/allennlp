...
## Job Metadata
#SBATCH --job-name=Supervised_I_II_Debate
#SBATCH --output=/checkpoint/%u/debate_out/Supervised-I-II-%j.out
#SBATCH --error=/checkpoint/%u/debate_out/Supervised-I-II-%j.err
