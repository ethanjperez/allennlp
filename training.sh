...
allennlp train training_config/bidaf.train=dev.jsonnet --serialization-dir tmp/ab.rounds\=1.independent.pg.j.dropout=0.5 -j training_config/bidaf.dropout=0.5.jsonnet -u

# Evaluate A/B/J (add -e, no -u)
allennlp train training_config/bidaf.train=dev.jsonnet --serialization-dir tmp/ab.rounds\=1.independent.pg.j.dropout=0.5 -j training_config/bidaf.dropout=0.5.jsonnet -e
