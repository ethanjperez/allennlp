...
allennlp train training_config/bidaf.patience=None.num_epochs=200.jsonnet --debate_mode ab --serialization-dir tmp/ab.3.pt=rr.2 -j tmp/rr.2/model.tar.gz
...
allennlp train training_config/bidaf.patience=None.num_epochs=200.jsonnet --debate_mode ab --serialization-dir tmp/ab.3.pt=rr.2 -j tmp/rr.2/model.tar.gz -u
allennlp train training_config/bidaf.patience=None.num_epochs=200.jsonnet --debate_mode ab --serialization-dir tmp/ab.3.pt=gr.2 -j tmp/gr.2/model.tar.gz -u
...
### SLURM
# sbatch job
export SERIALIZATION_DIR=tmp/ab.3.pt=rr.2  # NB: Update every run!
