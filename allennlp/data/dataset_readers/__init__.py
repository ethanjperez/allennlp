...
from allennlp.data.dataset_readers.reading_comprehension import SquadReader, TriviaQaReader, QuACReader, QangarooReader, RaceReader, BabiSingleReader, BabiCopyReader
