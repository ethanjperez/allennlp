...
@DatasetReader.register("babi_copy")
class BabiCopyReader(DatasetReader):
    """
...
if __name__ == "__main__":
    ...
    # Dump JSON Files
    with open(os.path.join(babi_path, "babi-copy-train-v1.0.json"), 'w') as f:
        json.dump(train_data, f)

    with open(os.path.join(babi_path, "babi-copy-dev-v1.0.json"), 'w') as f:
        json.dump(val_data, f)

    with open(os.path.join(babi_path, "babi-copy-test-v1.0.json"), 'w') as f:
