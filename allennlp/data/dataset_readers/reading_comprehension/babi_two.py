...
@DatasetReader.register("babi_double")
class BabiDoubleReader(DatasetReader):
    """
...
if __name__ == "__main__":
    ...
    babi_path = "datasets/babi_double"
    ...
    for dt in ['train', 'valid', 'test']:
        dt_path = os.path.join(race_raw_path, "qa2_%s.txt" % dt)
    ...
    # Dump JSON Files
    with open(os.path.join(babi_path, "babi-double-train-v1.0.json"), 'w') as f:
        json.dump(train_data, f)

    with open(os.path.join(babi_path, "babi-double-dev-v1.0.json"), 'w') as f:
        json.dump(val_data, f)

    with open(os.path.join(babi_path, "babi-double-test-v1.0.json"), 'w') as f:
